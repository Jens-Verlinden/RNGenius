package be.mobile.rngenius.greeting;
...
import be.mobile.rngenius.greeting.service.GreetingService;
import be.mobile.rngenius.greeting.service.GreetingServiceException;
...
public class GreetingServiceTest {
  ...
  @Mock GreetingRepository greetingRepository;
  ...
  void givenNoGreetingInDb_whenGetGreeting_thenErrorIsThrown() throws Exception {
    ...
    // when
    GreetingServiceException ex =
        Assertions.assertThrows(
            GreetingServiceException.class, () -> greetingService.getGreeting());
