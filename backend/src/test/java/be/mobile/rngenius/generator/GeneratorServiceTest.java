package be.mobile.rngenius.generator;
...
import be.mobile.rngenius.generator.repo.GeneratorRepository;
...
import be.mobile.rngenius.option.repo.OptionRepository;
import be.mobile.rngenius.participant.model.Participant;
import be.mobile.rngenius.participant.repo.ParticipantRepository;
import be.mobile.rngenius.result.model.Result;
import be.mobile.rngenius.result.repo.ResultRepository;
import be.mobile.rngenius.selection.model.Selection;
import be.mobile.rngenius.selection.repo.SelectionRepository;
import be.mobile.rngenius.user.model.User;
import be.mobile.rngenius.user.service.UserService;
...
public class GeneratorServiceTest {
  ...
  @InjectMocks private GeneratorService generatorService;
  ...
  public void setUp() throws Exception {
    ...
    option1 =
        new Option("Option 1", new ArrayList<>(List.of("Category1", "Category2")), "Description 1");
    option1.id = 1L;
    option1.setGenerator(generator);
    option2 =
        new Option("Option 2", new ArrayList<>(List.of("Category3", "Category4")), "Description 2");
    option2.id = 2L;
  ...
  @Test
  void givenValidIdAndRequesterId_whenGettingGeneratorById_thenGeneratorReturned()
      throws Exception {
    // given
  ...
  void givenInvalidId_whenGettingGeneratorById_thenGeneratorServiceExceptionIsThrown() {
    ...
    // when
    GeneratorServiceException ex =
        assertThrows(
            GeneratorServiceException.class,
            () -> generatorService.getGeneratorById(generator.id, user1.id));
  ...
  @Test
  void
      givenUnauthorizedRequesterId_whenGettingGeneratorById_thenGeneratorServiceAuthorizationExceptionIsThrown() {
    // given
    when(generatorRepository.findGeneratorById(generator.id)).thenReturn(generator);

    // when
    GeneratorServiceAuthorizationException ex =
        assertThrows(
            GeneratorServiceAuthorizationException.class,
            () -> generatorService.getGeneratorById(generator.id, (long) -1));
  ...
  void givenNullGenerator_whenAddingGenerator_thenGeneratorServiceExceptionIsThrown() {
    ...
    GeneratorServiceException ex =
        assertThrows(
            GeneratorServiceException.class, () -> generatorService.addGenerator(null, user1.id));
  ...
  @Test
  void givenValidGeneratorAndRequesterId_whenUpdatingGenerator_thenGeneratorUpdated()
      throws Exception {
    // given
    when(generatorRepository.findGeneratorById(generator.id)).thenReturn(generator);
  ...
  @Test
  void
      givenUnauthorizedRequesterId_whenUpdatingGenerator_thenGeneratorServiceAuthorizationExceptionIsThrown()
          throws Exception {
    // given
    when(generatorRepository.findGeneratorById(generator.id)).thenReturn(generator);
    ...
    GeneratorServiceAuthorizationException ex =
        assertThrows(
            GeneratorServiceAuthorizationException.class,
            () -> generatorService.updateGenerator(generator.id, generator, user2.id));
  ...
  @Test
  void givenValidIdAndRequesterId_whenDeletingGeneratorById_thenGeneratorDeleted()
      throws Exception {
    // given
    when(generatorRepository.findGeneratorById(generator.id)).thenReturn(generator);
  ...
  @Test
  void
      givenUnauthorizedRequesterId_whenDeletingGeneratorById_thenGeneratorServiceAuthorizationExceptionIsThrown()
          throws Exception {
    // given
    when(generatorRepository.findGeneratorById(generator.id)).thenReturn(generator);
    ...
    GeneratorServiceAuthorizationException ex =
        assertThrows(
            GeneratorServiceAuthorizationException.class,
            () -> generatorService.deleteGeneratorById(generator.id, user2.id));
  ...
  @Test
  void givenValidGeneratorIdOptionAndRequesterId_whenAddingGeneratorOption_thenOptionAdded()
      throws Exception {
    // given
    when(generatorRepository.findGeneratorById(generator.id)).thenReturn(generator);
  ...
  @Test
  void
      givenValidGeneratorIdOptionAndRequesterIdAndOptionWithNameAlreadyExist_whenAddingGeneratorOption_thenOptionDescriotpionIsOverwrittenAndNewCategroiesAreAdded()
          throws Exception {
    // given
  ...
  void givenNullOption_whenAddingGeneratorOption_thenGeneratorServiceExceptionIsThrown() {
    ...
    GeneratorServiceException ex =
        assertThrows(
            GeneratorServiceException.class,
            () -> generatorService.addGeneratorOption(generator.id, null, user1.id));
  ...
  @Test
  void
      givenValidOptionIdCategoryAndRequesterId_whenDeletingCategorizedGeneratorOption_thenOptionDeleted()
          throws Exception {
    // given
  ...
  @Test
  void
      givenValidOptionIdCategoryAndRequesterId_whenDeletingCategorizedGeneratorOptionButStillCategoryRemaining_thenOptionCateryDeleted()
          throws Exception {
    // given
  ...
  @Test
  void
      givenUnauthorizedRequesterId_whenDeletingCategorizedGeneratorOption_thenGeneratorServiceAuthorizationExceptionIsThrown()
          throws Exception {
    // given
    ...
    GeneratorServiceAuthorizationException ex =
        assertThrows(
            GeneratorServiceAuthorizationException.class,
            () ->
                generatorService.deleteCategorizedGeneratorOption(
                    option1.id, "category", user2.id));
  ...
  @Test
  void givenValidGeneratorIdAndRequesterId_whenGeneratingOption_thenOptionReturned()
      throws Exception {
    // given
  ...
  void givenNoOptions_whenGeneratingOption_thenGeneratorServiceExceptionIsThrown() {
    ...
    GeneratorServiceException ex =
        assertThrows(
            GeneratorServiceException.class,
            () -> generatorService.generateOption(generator.id, user1.id));
  ...
  @Test
  void givenValidOptionIdAndRequesterId_whenPrioritisingOption_thenOptionPrioritised()
      throws Exception {
    // given
    when(selectionRepository.findSelectionByParticipantUserIdAndOptionId(user1.id, option1.id))
        .thenReturn(selection1);
  ...
  @Test
  void
      givenValidGeneratorIdEmailAndRequesterId_whenAddingGeneratorParticipant_thenParticipantAdded()
          throws Exception {
    // given
    when(generatorRepository.findGeneratorById(generator.id)).thenReturn(generator);
    when(userService.getUserByEmail(user2.getEmail())).thenReturn(user2);
    when(participantRepository.findParticipantByUserIdAndGeneratorId(user2.id, generator.id))
        .thenReturn(null);
  ...
  @Test
  void
      givenExistingParticipant_whenAddingGeneratorParticipant_thenGeneratorServiceExceptionIsThrown()
          throws Exception {
    // given
    when(generatorRepository.findGeneratorById(generator.id)).thenReturn(generator);
    when(userService.getUserByEmail(user2.getEmail())).thenReturn(user2);
  ...
  @Test
  void
      givenUnauthorizedRequesterId_whenAddingGeneratorParticipant_thenGeneratorServiceAuthorizationExceptionIsThrown()
          throws Exception {
    // given
    when(generatorRepository.findGeneratorById(generator.id)).thenReturn(generator);
    ...
    GeneratorServiceAuthorizationException ex =
        assertThrows(
            GeneratorServiceAuthorizationException.class,
            () ->
                generatorService.addGeneratorParticipant(generator.id, user2.getEmail(), user2.id));
  ...
  @Test
  void
      givenValidGeneratorIdAndParticipantId_whenDeletingGeneratorParticipant_thenParticipantDeleted()
          throws Exception {
    // given
    when(generatorRepository.findGeneratorById(generator.id)).thenReturn(generator);
    when(participantRepository.findParticipantByUserIdAndGeneratorId(user2.id, generator.id))
  ...
  @Test
  void
      givenNonExistentParticipant_whenDeletingGeneratorParticipant_thenGeneratorServiceExceptionIsThrown()
          throws Exception {
    // given
    when(generatorRepository.findGeneratorById(generator.id)).thenReturn(generator);
    when(participantRepository.findParticipantByUserIdAndGeneratorId(user2.id, generator.id))
  ...
  @Test
  void
      givenOwnerDeletingThemselves_whenDeletingGeneratorParticipant_thenGeneratorServiceAuthorizationExceptionIsThrown()
          throws Exception {
    // given
    when(generatorRepository.findGeneratorById(generator.id)).thenReturn(generator);
    ...
    GeneratorServiceException ex =
        assertThrows(
            GeneratorServiceException.class,
            () -> generatorService.removeGeneratorParticipant(generator.id, user1.id, user1.id));
  ...
  @Test
  void
      givenUnauthorizedRequesterId_whenDeletingGeneratorParticipant_thenGeneratorServiceAuthorizationExceptionIsThrown()
          throws Exception {
    // given
    when(generatorRepository.findGeneratorById(generator.id)).thenReturn(generator);
    ...
    GeneratorServiceAuthorizationException ex =
        assertThrows(
            GeneratorServiceAuthorizationException.class,
            () -> generatorService.removeGeneratorParticipant(generator.id, user2.id, user2.id));

    // then
    assertEquals("generator", ex.getField());
    assertEquals(
        "You are not authorized to delete participants from this generator", ex.getMessage());
  }

  @Test
  void givenValidGeneratorIdAndRequesterId_whenLeavingGenerator_thenParticipantDeleted()
      throws Exception {
    // given
    when(generatorRepository.findGeneratorById(generator.id)).thenReturn(generator);
    when(participantRepository.findParticipantByUserIdAndGeneratorId(user2.id, generator.id))
  ...
  @Test
  void
      givenOwnerLeavingGenerator_whenLeavingGenerator_thenGeneratorServiceAuthorizationExceptionIsThrown()
          throws Exception {
    // given
    when(generatorRepository.findGeneratorById(generator.id)).thenReturn(generator);
    ...
    GeneratorServiceException ex =
        assertThrows(
            GeneratorServiceException.class,
            () -> generatorService.leaveGenerator(generator.id, user1.id));
  ...
  @Test
  void givenValidGeneratorIdAndRequesterId_whenTogglingNotifications_thenNotificationsToggled()
      throws Exception {
    // given
    when(participantRepository.findParticipantByUserIdAndGeneratorId(user1.id, generator.id))
  ...
  @Test
  void
      givenNonExistentParticipant_whenTogglingNotifications_thenGeneratorServiceExceptionIsThrown() {
    // given
    when(participantRepository.findParticipantByUserIdAndGeneratorId(user1.id, generator.id))
        .thenReturn(null);
  ...
  void givenValidRequesterId_whenGettingMyNotifiedResults_thenResultsReturned() {
    ...
    when(participantRepository.findParticipantsByUserId(user1.id))
  ...
  @Test
  void
      givenValidRequesterId_whenGettingMyNotifiedResultsWithNoNotifications_thenEmptyResultsReturned() {
    // given
  ...
  @Test
  void givenValidGeneratorIdCategoryAndRequesterId_whenPrioritisingCategory_thenOptionsPrioritised()
      throws Exception {
    // given
    ...
    when(selectionRepository.findSelectionByParticipantUserIdAndOptionId(user1.id, option1.id))
        .thenReturn(selection1);
    when(selectionRepository.findSelectionByParticipantUserIdAndOptionId(user1.id, option2.id))
        .thenReturn(selection2);
  ...
  @Test
  void givenAllOptionsAlreadyPrioritised_whenPrioritisingCategory_thenOptionsUnprioritised()
      throws Exception {
    // given
    option1.setCategories(List.of("Category1"));
    option2.setCategories(List.of("Category1"));
  ...
  @Test
  void givenValidGeneratorIdCategoryAndRequesterId_whenExcludingCategory_thenOptionsExcluded()
      throws Exception {
    // given
    option1.setCategories(List.of("Category1"));
    option2.setCategories(List.of("Category1"));
  ...
  @Test
  void givenAllOptionsAlreadyExcluded_whenExcludingCategory_thenOptionsUnexcluded()
      throws Exception {
    // given
    option1.setCategories(List.of("Category1"));
    option2.setCategories(List.of("Category1"));
  ...
  @Test
  void givenInvalidOptionId_whenGettingOptionById_thenGeneratorServiceExceptionIsThrown()
      throws Exception {
    // given
    ...
    InvocationTargetException ex =
        assertThrows(
            InvocationTargetException.class, () -> method.invoke(generatorService, option1.id));
  ...
  @Test
  void
      givenValidParticipantIdAndOptionId_whenGettingSelectionByParticipantIdAndOptionId_thenSelectionReturned()
          throws Exception {
    // given
    when(selectionRepository.findSelectionByParticipantUserIdAndOptionId(user1.id, option1.id))
        .thenReturn(selection1);
    ...
    // when
    Method method =
        GeneratorService.class.getDeclaredMethod(
            "getSelectionByParticipantUserIdAndOptionId", Long.class, Long.class);
    method.setAccessible(true);
  ...
  @Test
  void
      givenInvalidParticipantIdAndOptionId_whenGettingSelectionByParticipantIdAndOptionId_thenGeneratorServiceExceptionIsThrown()
          throws Exception {
    // given
    when(selectionRepository.findSelectionByParticipantUserIdAndOptionId(user1.id, option1.id))
        .thenReturn(null);
    ...
    InvocationTargetException ex =
        assertThrows(
            ...
            () -> method.invoke(generatorService, user1.id, option1.id));

    // then
    assertEquals(GeneratorServiceException.class, ex.getTargetException().getClass());
    assertEquals("selection", ((GeneratorServiceException) ex.getTargetException()).getField());
    assertEquals(
        "No selection with this participant and option", ex.getTargetException().getMessage());
  }
}
