package be.mobile.rngenius.user;
...
public class UserTest {
  ...
  void givenNullRefreshToken_whenSettingRefreshToken_thenThrowException() {
    UserException ex =
        Assertions.assertThrows(UserException.class, () -> validUser.setRefreshToken(null));
  ...
  void givenEmptyRefreshToken_whenSettingRefreshToken_thenThrowException() {
    ...
    UserException ex =
        Assertions.assertThrows(
            UserException.class, () -> validUser.setRefreshToken(emptyRefreshToken));
