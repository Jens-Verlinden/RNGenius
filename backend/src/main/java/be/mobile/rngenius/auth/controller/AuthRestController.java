package be.mobile.rngenius.auth.controller;

import be.mobile.rngenius.auth.jwt.JwtUtil;
import be.mobile.rngenius.auth.model.request.LoginReq;
import be.mobile.rngenius.auth.model.request.PasswdReq;
import be.mobile.rngenius.auth.model.request.RefreshReq;
import be.mobile.rngenius.auth.model.response.ErrorRes;
import be.mobile.rngenius.auth.model.response.LoginRes;
import be.mobile.rngenius.auth.model.response.RefreshRes;
...
public class AuthRestController {
  ...
  public ResponseEntity<String> register(@RequestBody User user)
      throws UserServiceException, UserException {
  ...
  public ResponseEntity<?> login(@RequestBody LoginReq loginReq) {
    ...
    try {
      ...
      ErrorRes errorResponse =
          new ErrorRes(
              "credentials", "Incorrect password for user with the e-mail " + loginReq.email + "!");
      return ResponseEntity.status(HttpStatus.UNAUTHORIZED).body(errorResponse);
    } catch (Exception e) {
      ErrorRes errorResponse =
          new ErrorRes("credentials", "User with e-mail " + loginReq.email + " not found!");
      return ResponseEntity.status(HttpStatus.UNAUTHORIZED).body(errorResponse);
    }
  }
  ...
  public ResponseEntity<String> changePassword(
      @RequestBody PasswdReq passwdReq, @RequestHeader("Authorization") String token)
      throws UserServiceException, UserException {
  ...
  public ResponseEntity<String> logoutAllDevices(@RequestHeader("Authorization") String token)
