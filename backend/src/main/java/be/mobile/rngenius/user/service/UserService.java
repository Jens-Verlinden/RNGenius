...
public class UserService {
  ...
  protected byte[] KEY =
      Secret.getSecret() != null ? Arrays.copyOf(Secret.getSecret().getBytes(), 32) : new byte[32];
  ...
  @Transactional
  public void changePassword(Long requesterId, String oldPassword, String newPassword)
